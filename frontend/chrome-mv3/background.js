var background = (() => {
	...
	const defineBackground = (argument) => {
		if (argument == null || typeof argument === 'function') { return { main: argument }; }
		return argument;
	};
	var _MatchPattern = class {
		...
		escapeForRegex = string => string.replaceAll(/[.*+?^${}()|[\]\\]/g, String.raw`\$&`);
	};
	...
	async function reloadRuntimeContentScriptMv3(contentScript) {
		...
		const matches = registered.filter((cs) => {
			let _a2; let
				_b2;
			const hasJs = (_a2 = contentScript.js) == null
				? void 0
				: _a2.find((js) => {
					let _a3;
					return (_a3 = cs.js) == null ? void 0 : _a3.includes(js);
				});
			const hasCss = (_b2 = contentScript.css) == null
				? void 0
				: _b2.find((css) => {
					let _a3;
